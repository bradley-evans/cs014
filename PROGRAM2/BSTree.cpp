...
void preOrder( ) {
/*
Traverse and print the tree in preorder notation following the printing 
...
void inOrder( ) {
/*
Traverse and print the tree in inorder notation following the printing 
guidelines specified above.
*/
...
void postOrder( ) {
/*
Traverse and print the tree in postorder notation following the printing 
guidelines specified above.
*/
