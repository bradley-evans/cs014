...
int main( ) {
  ...
  cout << "Test 13" << endl;
  tree2.insert(K);
  //tree2.visualizeTree("test13ins-preLotRs.dot");
  tree2.insert(P);
  //tree2.visualizeTree("test13ins.dot");
  tree2.remove(P);
  //tree2.visualizeTree("test13del.dot");
  printOrders(&tree2);
  cout << "----------------------------------------------------" << endl;
  cout << "Test 14" << endl;
  tree2.insert(H);
  tree2.remove(H);
  printOrders(&tree2);
  //tree2.visualizeTree("test14_end.dot");
  cout << "----------------------------------------------------" << endl;
  cout << "Test 15" << endl;
  tree2.insert(H);
  //tree2.visualizeTree("test15_afterinsert.dot");
  tree2.remove(C);
  printOrders(&tree2);
  cout << "----------------------------------------------------" << endl;
